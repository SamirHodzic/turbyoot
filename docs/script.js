...
const searchIndex = [
  ...
  },
  {
    ...
    sections: [
      ...
      { title: 'ctx.render()', content: 'render template file using configured template engine supports EJS Pug Handlebars Express-compatible engines render HTML templates with data configure views directory register engines', id: 'ctx-render' },
      ...
      { title: 'auth()', content: 'Authentication middleware for user authentication and authorization.' },
      {
        ...
        content: 'template engine render HTML templates using template engines EJS Pug Handlebars configure views directory register engines use ctx.render render templates with data template rendering view engine EJS Pug Handlebars support',
        id: 'template-engine',
      },
    ],
  },
